...
public sealed class EngagementWorkspaceService
{
    ...
    [
        ...
        new("Parcel or delivery scam", "Verification questions", "Verify the delivery claim without opening tracking links or paying a redelivery fee", ["Ask for the carrier's full legal name and consignment reference", "Check the reference only on the carrier site found independently", "Record the delivery address claim without confirming a real address", "Do not pay customs or redelivery charges from message links"]),
        new("Advance-fee or inheritance scam", "Claims under review", "Document the claimed entitlement and advance-fee demand", ["Request the legal entity, jurisdiction, and public registration", "Ask for the written legal basis and itemised fees", "Record beneficiary, inheritance, prize, or release claims", "Never provide identity documents, bank details, or advance payment"]),
        new("Romance or relationship scam", "Claims under review", "Test changing personal stories without sharing real emotional or identity details", ["Keep the fictional persona consistent and emotionally neutral", "Ask for one verifiable, non-sensitive detail at a time", "Record emergency, travel, military, hospital, and money claims", "Stop if pressure, threats, explicit content, or requests for real-world meetings appear"]),
        new("Fake technical support", "Verification questions", "Verify the support claim without installing software or giving device access", ["Ask for the legal company, case reference, and published support page", "Do not install AnyDesk, TeamViewer, Quick Assist, or similar tools", "Never share screen contents, codes, passwords, or device identifiers", "End engagement when remote access or payment is demanded"]),
        new("Investment or crypto scam", "Claims under review", "Document investment promises without transferring funds or connecting a wallet", ["Request the regulated legal entity and registration number", "Record promised returns, fees, wallet addresses, and withdrawal conditions", "Verify regulator claims using the regulator site found independently", "Never connect a wallet, disclose recovery words, or send a test payment"]),
        new("Job or task scam", "Verification questions", "Verify the employer and role without sharing identity documents or paying fees", ["Ask for the employer's legal name, registered address, and vacancy reference", "Verify the vacancy on a company site found independently", "Record equipment cheque, training fee, crypto, and commission claims", "Never provide identity documents, banking credentials, or upfront payment"]),
        new("Organisation impersonation", "Verification questions", "Check the claimed authority through independently sourced channels", ["Ask for the exact department, case reference, and public switchboard", "Do not use telephone numbers or links supplied in the message", "Record threats, account actions, and secrecy instructions", "Never disclose security codes, move money, or impersonate an authority in reply"]),
